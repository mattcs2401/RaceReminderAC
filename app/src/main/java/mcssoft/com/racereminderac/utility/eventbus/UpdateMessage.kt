 ...
 * @param adapterPos - The position of the selected row in the RaceXml adapter.
 * @param updateTo   - The id of the UI component, relative to the RaceXml object column value.
